...
describe('ASYNC Capstone API - Auth', () => {
  ...
  beforeEach(() => User.hashPassword(password).then(digest => User.create({
    _id: id,
    firstName,
    lastName,
    username,
  ...
  describe('POST /api/login', () => {
    ...
    it('should reject requests with empty string username', () => chai
      .request(app)
      .post('/api/login')
      .send({ username: '', password })
      .then((res) => {
    ...
    it('should reject requests with empty string password', () => chai
      .request(app)
      .post('/api/login')
      .send({ username, password: '' })
      .then((res) => {
    ...
    it('should reject requests with incorrect username', () => chai
      .request(app)
      .post('/api/login')
